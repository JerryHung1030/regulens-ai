    ...
    try:
        ...
        for i, chunk_text in enumerate(text_chunks):
            if not chunk_text.strip(): # Skip empty chunks if any were produced
                ...
                total_chunks -=1 # Adjust total_chunks if we skip one. This might be tricky if done often.
                                # Better to ensure _create_text_chunks doesn't produce empty strings if possible.
                continue
