...
datas = [
    ...
    ('sample_data/sample1_資通安全實地稽核Demo', 'sample_data/sample1_資通安全實地稽核Demo'),
    ('sample_data/sample2_符合規範Demo', 'sample_data/sample2_符合規範Demo'),
    ('sample_data/sample3_不符合規範Demo', 'sample_data/sample3_不符合規範Demo'),
    ('sample_data/sample1_資通安全實地稽核Demo/external_regulations', 'sample_data/sample1_資通安全實地稽核Demo/external_regulations'),
    ('sample_data/sample1_資通安全實地稽核Demo/procedures', 'sample_data/sample1_資通安全實地稽核Demo/procedures'),
